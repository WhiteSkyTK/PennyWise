...
class PennywiseApplication : Application(), Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    override fun onCreate() {
        ...
        val db = Firebase.firestore // Recommended way to get Firestore instance with KTX
        val settings = firestoreSettings {
            isPersistenceEnabled = true // Correct: Assign directly to the property
            cacheSizeBytes = FirebaseFirestoreSettings.CACHE_SIZE_UNLIMITED // Correct: Assign directly
            // You can also use specific values e.g. cacheSizeBytes = 100 * 1024 * 1024 // 100 MB
        }
